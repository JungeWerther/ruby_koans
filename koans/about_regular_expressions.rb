...
class AboutRegularExpressions < Neo::Koan
  ...
  # hmm... in below test they're all the same
  def test_difference_cc_a
    grays = /(A|B|C) Gray/
    cc = /([ABC]) Gray/
    assert_equal "A Gray"[grays], "A Gray"[cc]
    assert_equal "A", "A Gray"[grays, 1]
    assert_equal "A", "A Gray"[cc, 1]
    assert_equal nil, "D Gray"[grays, 1]
    assert_equal nil, "D Gray"[cc, 1]
  end
  # ------------------------------------------------------------------
