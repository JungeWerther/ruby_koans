...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: 
    # iterable.inject(initial) { |accumulator, current| operator(accumulator, current)}
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    # NB. a do |b| ... end syntax is like with a as b: in python
  ...
  # ==> probably because a bytestream must be opened and closed (?)
