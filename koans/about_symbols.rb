...
class AboutSymbols < Neo::Koan
  ...
  # ANSWER: because symbols with the same identifier will trivially refer to the same object. 
  ...
  def test_symbols_are_not_strings
    ...
    assert_equal true, symbol.to_s.eql?("ruby")
  end
  ...
  # because of potential unexpected behaviour due to naming conflicts down the line (?)
end
